    ...
    <div class="glass-card p-4 rounded-4 shadow-sm">
        ...
        <form action="{{ route('admin.providers.update', $provider) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-2 mb-2">
                <div class="col-md-6"><label class="form-label fw-semibold small mb-1">Business Name *</label><input type="text" name="business_name" class="form-control form-control-sm rounded-3" required value="{{ old('business_name', $provider->business_name) }}"></div>
                <div class="col-md-6"><label class="form-label fw-semibold small mb-1">Phone</label><input type="text" name="phone" class="form-control form-control-sm rounded-3" value="{{ old('phone', $provider->phone) }}"></div>
            </div>
